...
import com.or2go.vendor.showstorenearme.storeList.Or2GoStore;
...
//                            mMap.addMarker(markerOptions);
    ...
    private void setArrayData(LatLng latLng, Or2GoStore or2GoStore) {
        String customerloc = latLng.latitude + "," + latLng.longitude;
        String storeloc = or2GoStore.getGeolocation();
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    if (status.equals("OK")) {
                        ...
                        locationArrayList.add(new MarkerData(Double.parseDouble(arrOfStr[0]), Double.parseDouble(arrOfStr[1]), or2GoStore.vName, distanceValue));
